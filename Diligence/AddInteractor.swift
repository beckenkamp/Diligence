...
class AddInteractor: NSObject, AddInteractorInput {
    ...
    func saveNewEntryWithDescription(description: String, value: Float, date: NSDate){        
        let newEntry = DiligenceItem(type: "http://52.35.220.218/api/types/4/", itemDescription: description, location: "http://52.35.220.218/api/locations/4/", value: value, expireDate: date, expireDateString: nil)
